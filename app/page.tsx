...
type NodeDiagnostics = {
  ...
  connectivity?: {
    ...
    protocols: Array<{ protocol: string; state: string; configured: boolean; taskStatus: string | null; lastError: string; transport: string; port: number; installed: boolean; runtimeActive: boolean; listening: boolean; hostFirewall: string; cloudFirewall: string }>;
    note: string;
  };
};
